...
fun CreateTravelScreen(
            ...
            LazyColumn(
                ...
                items(uiState.categories) { category ->
                    CategoryCard(
                        ...
                        onEditCategoryClick = {
                            createTravelViewModel.showEditCategoryDialog(
                                category.id
                            )
                        },

                        onRemoveCategoryClick = {
                            createTravelViewModel.removeCategory(
                                category.id
                            )
                        },

                        onEditItemClick = { itemId ->
                            createTravelViewModel.showEditItemDialog(
        ...
        AlertDialog(
            ...
            text = {
                OutlinedTextField(
                    ...
                    onValueChange = { newName ->
                        createTravelViewModel.onNewCategoryNameChange(
                            newName
                        )
                    },
                    label = {
        ...
        AlertDialog(
            ...
            text = {
                OutlinedTextField(
                    ...
                    onValueChange = { newName ->
                        createTravelViewModel.onNewItemNameChange(
                            newName
                        )
                    },
                    label = {
    ...
    if (uiState.editingCategoryId != null) {
        AlertDialog(
            onDismissRequest = {
                createTravelViewModel.hideEditCategoryDialog()
            },
            ...
            text = {
                OutlinedTextField(
                    ...
                    onValueChange = { newName ->
                        createTravelViewModel.onEditedCategoryNameChange(
                            newName
                        )
                    },
                    label = {
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        createTravelViewModel.renameCategory()
                    }
                ) {
                    Text(
                        text = stringResource(
    ...
    if (uiState.editingItemId != null) {
        AlertDialog(
            onDismissRequest = {
                createTravelViewModel.hideEditItemDialog()
            },
            ...
            text = {
                OutlinedTextField(
                    value = uiState.editedItemName,
                    onValueChange = { newName ->
                        createTravelViewModel.onEditedItemNameChange(
                            newName
                        )
                    },
                    label = {
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        createTravelViewModel.renameItem()
                    }
                ) {
                    Text(
                        text = stringResource(
